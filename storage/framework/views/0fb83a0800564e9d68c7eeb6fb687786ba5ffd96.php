<?php $__env->startSection('title', $champions->name.', '.$champions->title.' - League of Legends'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid text-center user-select-none">
        ...
        <div class="row">
            <div class="col">
                <p class="text-light text-uppercase fw-bold fst-italic" style="margin-top: -200px; margin-bottom: -5px"><?php echo e($champions->title); ?></p>
    ...
    <div class="container-fluid text-center align-items-top bg-dark">
        <div class="row justify-content-center" style="padding: 50px 0">
            <div class="col-2 mt-2 border-end border-light">
                ...
                <p class="text-light text-uppercase"><?php echo e($champions->role); ?></p>
            </div>
